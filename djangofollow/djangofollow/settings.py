"""
Django settings for djangofollow project.
...
SECRET_KEY = 'django-insecure-i(ss43su15!*5#@d^#e!0&0u1r&9hcmp$px-4m7@6m8(3ua$z7'
...
ROOT_URLCONF = 'djangofollow.urls'
...
WSGI_APPLICATION = 'djangofollow.wsgi.application'
